...
<head>
  ...
  <title>Sistema IoT de Monitoreo FLACUARIOT</title>
...
<div class="mdl-layout mdl-js-layout color--gray is-small-screen login">
  <center><span class="mdl-card__title-text text-color--smooth-gray">Autores: PROYECTO FINAL DE CARRERA 2021  </span></center>
                  ...
                  <form class="" action="<?php echo base_url('login/dologin')?>" method="post">
                    ...
                    <center><div class="mdl-grid">
                       <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
                            <span class="mdl-card__title-text text-color--smooth-gray">FLACUARIOT - Proyecto Final - UTN-FRT</span>
                        </div></center>
                        <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
