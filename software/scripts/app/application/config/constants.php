...
defined('MQTT_USER') OR define('MQTT_USER', '8Ck0VMBEt7VPXO5');
defined('MQTT_PASSWORD') OR define('MQTT_PASSWORD', 'p4l2lTajlrbovU2');
defined('ROOT_TOPIC') OR define('ROOT_TOPIC', 'v3FP3BCFf6NbVK0');
